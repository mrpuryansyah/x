...
public class ActivitySelengkapnyaSinkronisasiData extends AppCompatActivity {
    Context context = ActivitySelengkapnyaSinkronisasiData.this;
    Adapter adapter;
        ...
        public void onBindViewHolder(@NonNull Adapter.MyViewHolder holder, int position) {
            ...
            holder.ivlampiran.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(context, ActivityFullscreenImageV2.class).putExtra("url", arrayList.get(position).getLampiran()));
                }
            });
        }
