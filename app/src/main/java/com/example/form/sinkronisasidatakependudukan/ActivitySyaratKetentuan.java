...
//        progressDialog.setCancelable(false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://service-tlive.tangerangkota.go.id/services/tlive/kependudukan/syarat_sinkronisasi", new Response.Listener<String>() {
            @Override
